    ...
    <main className="relative min-h-[100dvh] bg-obsidian overflow-hidden">
      ...
      >
            ...
            >
              <AnimatePresence mode="popLayout" initial={false}>
                {layout.offsets.map(offset => {
                  ...
                  const zTranslate =
                    offset === 0 ? 0 : -layout.zStep * absOffset;
                  ...
                  return (
                    ...
                    >
                      <div
                        ...
                        style={{
                          background:
                            "radial-gradient(ellipse at center, rgba(245,230,211,0.12) 0%, transparent 70%)",
        ...
        {total > 0 && (
          ...
          >
            <p className="font-script text-xl sm:text-2xl text-olive-light leading-tight break-words">
              {items[current]?.title}
            </p>
        ...
        <div className="absolute bottom-2 sm:bottom-8 left-1/2 -translate-x-1/2 translate-y-6 sm:translate-y-4 z-30 px-4 text-center">
          <p className="text-[8px] tracking-[0.15em] text-champagne/15">
            2026 ARA MUZICC All Rights Reserved
          </p>
        </div>
      </div>
    </main>
